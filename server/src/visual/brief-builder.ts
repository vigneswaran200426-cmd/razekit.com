// @ts-nocheck
// Ported from base44/shared/visual/brief-builder.ts (import extensions .ts→.js).
...
import { VISUAL_ASSET_TYPES, resolveVisualCategory, resolvePlatform, PROMPT_VERSION } from "./registry.js";
